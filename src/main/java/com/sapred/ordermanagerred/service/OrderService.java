...
public class OrderService {
    ...
    public void fill() {
        ...
        Company company1 = new Company("11", "Poto", Currency.SHEKEL, d3);
        Company company2 = new Company("12", "PotoGeula", Currency.SHEKEL, d2);
        Company company3 = new Company("13", "Grafgik", Currency.SHEKEL, d2);
        ...
        for (int i = 200; i < 500; i++) {
            if (i % 3 == 0)
                orders.add(new Order(Integer.toString(i), user2, user3, i * 2,null, Order.StatusOptions.DONE, company1, 143, LocalDateTime.now(), 2, true, d1));
            else if (i % 3 == 1)
                orders.add(new Order(Integer.toString(i), user6, user4, i * 2, null, Order.StatusOptions.CREATED, company1, 263, LocalDateTime.now(), 1, true, d2));
            else
                orders.add(new Order(Integer.toString(i), user7, user5, i * 2, null, Order.StatusOptions.DONE, company1, 324, LocalDateTime.now(), 3, true, d1));
        }
